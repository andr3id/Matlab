function [ FDS ] = FDSGaussianLoadNarrowband( zita, T, K, C, bWohler, f0, PSD, fwelch )
%FDSGaussianLoadNarrowband calcola l'FDS nel caso di sollecitazione
...
FDS = (K^bWohler)/C*n0plus*T.*(sqrt(2)*zRms).^bWohler*gamma(1+bWohler/2);
